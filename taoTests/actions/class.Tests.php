...
class taoTests_actions_Tests extends tao_actions_SaSModule {
	 ...
	 * 
	 * @return void
	 * @throws Exception @requiresRight id WRITE
	 */
	public function delete() {
		...
		if ($this->getRequestParameter ( 'uri' )) {
			...
			return $this->forward ( 'deleteClass', null, null, (array (
	 ...
	 * 
	 * @see tao_actions_TaoModule::moveInstance() @requiresRight uri WRITE
	 ...
	 * 
	 * @see tao_actions_TaoModule::cloneInstance() @requiresRight uri READ
	...
	/**
	 * Method called to navigate to the view that will allow a user to provide the necessary data to call for automatic test generation.
	 */
